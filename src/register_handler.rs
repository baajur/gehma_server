...
pub fn register_user(invitation_id: web::Path<String>, user_data: web::Json<UserData>, pool: web::Data<Pool>) ->
impl Future<Item = HttpResponse, Error = ServiceError> {
    web::block(move || {
        query(invitation_id.into_inner(), user_data.into_inner().password, pool)
    })
    .then(|res| match res {
...
fn query(invitation_id: String, password: String, pool: web::Data<Pool>) -> Result<SlimUser, crate::errors::ServiceError> {
